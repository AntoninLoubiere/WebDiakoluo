...
class ListPage extends Page {
    ...
    addTestToSection(test, sectionList, sync) {
        ...
        if (test.id == EDIT_KEY) {
            titleSpan.textContent = I18N.getTranslation("edited-test");
            ...
            if (sectionList == this.localTestList) {
                sectionList.insertBefore(template, sectionList.firstChild); // insert at first
            } else {
