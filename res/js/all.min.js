...
function modalShowCheck(id){localStorage.setItem(id,document.getElementById('modal-show').checked);}var LANGUAGES=['en','fr'];var LANGUAGES_BUTTONS={'en':"&#127468;&#127463; English",'fr':"&#127467;&#127479; Français"};var PATH_OFFSET=13;var DEFAULT_LANGUAGE='en';var LEGAL_PATH="/WebDiakoluo/legal.html";var translations=null;var universal=null;var languageSelector=document.getElementById("language-selector");class I18nElement extends HTMLElement{static get observedAttributes(){return['key'];}
...
button.onclick=function(){setLang(lang,false);languageSelector.textContent=button.textContent;if(document.location.pathname!=LEGAL_PATH)localStorage.setItem("lang",lang);}
parent.appendChild(button);}
let lang=localStorage.getItem("lang");if(lang==null){lang=detectLang();if(document.location.pathname!=LEGAL_PATH)loadModal('cookies');}
