...
function modalShowCheck(id){localStorage.setItem(id,document.getElementById('modal-show').checked);}var LANGUAGES=['en','fr'];var LANGUAGES_BUTTONS={'en':"&#127468;&#127463; English",'fr':"&#127467;&#127479; Français"};var translations=null;var universal=null;var languageSelector=document.getElementById("language-selector");class I18nElement extends HTMLElement{static get observedAttributes(){return['key'];}
...
onSetLang();}}
if(updateButton){languageSelector.textContent=document.querySelector("[lang="+lang+"]").textContent;}}
